...
from detection import fire_detection, suspect_localisation, action_recognition, initialisation
import argparse
import sys
import time
import face
...
def authentification():
    ...
    face_count=0
    ok = 0
    #video_capture = cv2.VideoCapture("yolov5/suspect_test.avi")
